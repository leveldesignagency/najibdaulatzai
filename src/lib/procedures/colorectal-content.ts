export const colorectalSections = [
  {
  ...
  {
    id: "pouch-surgery",
    heading: "Pouch Surgery (Ileal Pouch-Anal Anastomosis)",
    paragraphs: [
  ...
  {
    heading: "Booking a Colorectal Consultation",
    paragraphs: [
  ...
  {
    heading: "Stoma Formation and Reversal",
    paragraphs: [
