      ...
      <footer className="bg-charcoal-dark text-white">
        <SiteContainer className="py-16 lg:py-20">
          <div className="flex w-full flex-col items-center text-center">
            <ScrollReveal variant="scale-up" className="flex w-full justify-center">
              <Link
                href="/"
            ...
            <ScrollReveal variant="fade-up" delay={100} className="w-full">
              <nav
                ...
                className="flex w-full flex-col items-center gap-y-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-x-8 sm:gap-y-4"
              >
          ...
          <ScrollReveal variant="fade-up" delay={180} className="w-full">
            <div className="mt-16 flex w-full flex-col items-center gap-6 border-t border-white/10 pt-10 text-center sm:mt-20 sm:flex-row sm:items-center sm:justify-between sm:gap-12 sm:pt-12 sm:text-left">
              ...
              <p className="text-xs tracking-[0.08em] text-white/60 sm:shrink-0 sm:text-right">
                Designed by{" "}
                <a
